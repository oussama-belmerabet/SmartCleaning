        ...
        body: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/bilal-mansuri-vTj_dmFGB1Y-unsplash.jpg',
              ).image,
            ),
            gradient: LinearGradient(
              colors: [Color(0xFF1A1B1B), Color(0xFFF1F4F8)],
              stops: [0.0, 1.0],
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'LOGIN3_PAGE_Button-ForgotPassword_ON_TAP');
                                  logFirebaseEvent(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LOGIN3_PAGE_RichText_ouisf9xo_ON_TAP');
                                  logFirebaseEvent('RichText_navigate_to');

                                  context.pushNamed('CreateAccount5');
                                },
                                child: RichText(
                                  text: TextSpan(
                                    children: [
