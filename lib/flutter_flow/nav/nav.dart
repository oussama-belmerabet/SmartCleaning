...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? Login3Widget() : InitialpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/profilSeller',
          requireAuth: true,
          builder: (context, params) => ProfilSellerWidget(),
        ),
        FFRoute(
          name: 'SuccessPage',
          path: '/successPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailsWidget(
            serviceId: params.getParam('serviceId', ParamType.DocumentReference,
                false, ['users', 'messyPlace']),
          ),
        ),
        FFRoute(
          name: 'offers',
