          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('OFFERS_PAGE_Icon_c5z9xm45_ON_TAP');
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder<int>(
                        future: queryMessyPlaceRecordCount(),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              ...
                              children: List.generate(
                                  columnOffersRecordList.length, (columnIndex) {
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'OFFERS_PAGE__BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_call_number');
                                                    await launchUrl(Uri(
                                                      scheme: 'tel',
                                                      path: columnOffersRecord
                                                          .userphone,
                                                    ));
                                                  },
                                                  text: '',
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  final offersCreateData =
                                                                      createOffersRecordData(
                                                                    owner: columnOffersRecord
                                                                        .owner,
                                                                    createdAt:
                                                                        columnOffersRecord
                                                                            .createdAt,
                                                                    ...
                                                                    address:
                                                                        columnOffersRecord
                                                                            .address,
                                                                    date: columnOffersRecord
                                                                        .date,
                                                                    nbrChambre:
                                                                        columnOffersRecord
                                                                            .nbrChambre,
                                                                    period: columnOffersRecord
                                                                        .period,
                                                                    gender: columnOffersRecord
                                                                        .gender,
                                                                    userName:
                                                                        columnOffersRecord
                                                                            .userName,
